...
public class CreateUserYandexTest {
    ...
    @DisplayName("Проверяет, что можно зарегистрироваться с паролем из 6 символов")
    @Test
    public void signUpWithSixCharacterPassPositiveTest() {
    ...
    @DisplayName("Проверяет, что можно зарегистрироваться с паролем из 7 символов")
    @Test
